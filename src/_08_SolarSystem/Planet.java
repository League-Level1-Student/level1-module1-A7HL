...
public class Planet {
    ...
    int diameter;
    Color color;
    double avgDistFromSun;
    double numDays;
    
    public Planet(int d, Color color, double distance, double period) {
        this.diameter = d;
        this.color = color;
    ...
    public void draw(Graphics g, int numDays) {
         ...
         */
        int avgDistFromSun = (int) (this.avgDistFromSun/ 10);     // You can choose a different scaling than divided by 10
        int orbitalPeriod = numDays;
